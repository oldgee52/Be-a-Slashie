...
app.post("/access", (req, res) => {
    const { email, title, openingDate, teacherName, teacherEmail } = req.body;
    ...
    const mailOptions = {
        ...
        * {
        ...
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">課程名稱: ${title} </span></p>
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
        ...
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">老師姓名及聯絡資訊:${teacherName}/${teacherEmail}</span></p>
          </div>
